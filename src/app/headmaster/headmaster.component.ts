...
export class HeadmasterComponent implements OnInit {
  ...
  teacherCashflow:FormGroup;
  deleteTeacherCashflow:FormGroup;
  teacherspreadsheetform:FormGroup;
  teacherSalary:FormGroup;
  data;outputArray=[];
  secondarydata;
  y;z;
  passwordupdatedata;
  ...
  download;justview;downloadfees;justviewfees;downloadsalary;justviewsalary;downloadt;justviewt;
...
fromSeventeen:boolean=false;
viewsheetsalary:boolean=false;
fromEighteen:boolean=false;
viewsheett:boolean=false;
fromNineteen:boolean=false;
fromTwenty:boolean=false;
  ...
  ngOnInit(): void {
    this.createUserPrimaryform = this.fb.group({
     ...
     this.addPreviousOrgform = this.fb.group({
      ...
      this.teacherCashflow=this.fb.group({
        scholarno:[''],
        month:[''],
        year:[''],
        date:[''],
      ...
      this.teacherspreadsheetform = this.fb.group({
        sheetname:['',Validators.required],
        classes:[''],
        year:['',Validators.required],
        username:[''],
      ...
      this.teacherSalary = this.fb.group({
        sheetname:['',Validators.required],
        classes:[''],
      ...
      this.deleteTeacherCashflow = this.fb.group({
        scholarno:[''],
        month:[''],
        year:['']
      })
  ...
  getStudentFeesSpreadsheet(data){
    ...
    createTeacherCashflow(data){
      this.hero.createTeacherCashflow(this.teacherCashflow.value.scholarno,this.roletocheck,this.teacherCashflow.value.month,this.teacherCashflow.value.year,this.teacherCashflow.value.date,this.teacherCashflow.value.amount).subscribe(data=>{
        this.data=data;
        console.log(data);
      })
    }
    deleteTeacherCashflowfunction(data){
      this.hero.deleteTeacherCashflow(this.deleteTeacherCashflow.value.scholarno,this.roletocheck,this.deleteTeacherCashflow.value.month,this.deleteTeacherCashflow.value.year).subscribe(data=>{
        this.data=data;
        console.log(data);
      })
    }

    getTeacherSalarySpreadsheet(data){
      //normal teacher ss
      console.log(this.teacherspreadsheetform.value);
        this.hero.getTecaherSpreadsheet(this.roletocheck,this.teacherspreadsheetform.value.sheetname,this.teacherspreadsheetform.value.year,this.teacherspreadsheetform.value.username,this.teacherspreadsheetform.value.status,this.teacherspreadsheetform.value.googlespreadsheeturl,this.teacherspreadsheetform.value.amountstatus,this.teacherspreadsheetform.value.role,this.teacherspreadsheetform.value.userid,this.teacherspreadsheetform.value.father,this.teacherspreadsheetform.value.yoj,this.teacherspreadsheetform.value.dob,this.teacherspreadsheetform.value.add,this.teacherspreadsheetform.value.phone,this.teacherspreadsheetform.value.mother,this.teacherspreadsheetform.value.age,this.teacherspreadsheetform.value.previousorgdoc,this.teacherspreadsheetform.value.classes,this.teacherspreadsheetform.value.adminofclass,this.teacherspreadsheetform.value.scholarno).subscribe(data=>{
          this.data=data;
          console.log(data);
          this.downloadsalary=this.data.data.downloadspreadsheeturl;
      this.justviewsalary = this.data.data.viewspreadsheeturl;
      this.viewsheetsalary=true;
        
        })
      } 
      getSalaryTeacherSalarySpreadsheet(data){
        //salary spreadsheet 
        console.log(this.teacherSalary.value);
          this.hero.getTeacherSalarySpreadsheet(this.roletocheck,this.teacherSalary.value.sheetname,this.teacherSalary.value.year,this.teacherSalary.value.username,this.teacherSalary.value.status,this.teacherSalary.value.googlespreadsheeturl,this.teacherSalary.value.amountstatus,this.teacherSalary.value.role,this.teacherSalary.value.userid,this.teacherSalary.value.father,this.teacherSalary.value.yoj,this.teacherSalary.value.dob,this.teacherSalary.value.add,this.teacherSalary.value.phone,this.teacherSalary.value.mother,this.teacherSalary.value.age,this.teacherSalary.value.previousorgdoc,this.teacherSalary.value.classes,this.teacherSalary.value.adminofclass,this.teacherSalary.value.scholarno,this.teacherSalary.value.date,this.teacherSalary.value.amount,this.teacherSalary.value.month).subscribe(data=>{
            this.data=data;
            console.log(data);
            this.downloadt=this.data.data.downloadspreadsheeturl;
        this.justviewt = this.data.data.viewspreadsheeturl;
        this.viewsheett=true;
  ...
  one(){
   this.fromOne=true;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
   this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
  ...
  two(){
    this.fromOne=false;this.fromTwo=true;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  three(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=true;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  four(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=true;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  five(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=true;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  six(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=true;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  seven(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=true;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
  ...
  fifteen(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=true;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  sixteen(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=true;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  seventeen(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=true;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  eighteen(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=true;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
  ...
  nineteen(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=true;this.fromTwenty=false;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
   
  }
  twenty(){
    this.fromOne=false;this.fromTwo=false;this.fromThree=false;this.fromUpdate=false;this.fromupdateSecStu=false;this.fromSeventeen=false;this.fromEighteen=false;
    this.fromFour=false;this.fromFive=false;this.fromSix=false;this.fromSeven=false;this.fromSixteen=false;this.fromFifteen=false;this.fromNineteen=false;this.fromTwenty=true;
    this.fromEight=false;this.fromNine=false;this.fromTen=false;this.fromEleven=false;this.fromTwelve=false;this.fromThirteen=false;this.fromFourteen=false;
